...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('skydash/template') }}/public/skydash/template/vendors/font-awesome/css/font-awesome.min.css" />
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-8"><img src="{{ asset('skydash/template') }}/images/ExploreRoutes.png" width="150" height="500" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ asset('skydash/template') }}/index.html"><img src="{{ asset('skydash/template') }}/images/logo-kecil.png" alt="logo"/></a>
      </div>
              ...
              <a class="dropdown-item">
                <div class="d-flex">
                  <div class="flex-shrink-2 me-5">
                      <img src="{{ asset('skydash/template') }}/images/faces/admin.jpg" class="mr-2" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                <div class="d-flex mt-2"  style="font-size: 16px"><b>{{ auth()->user()->name }}</b></div>
              </div>
              </a>
              <a class="dropdown-item">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('bandara.index') }}">
          ...
          <li class="nav-item mt-3">
            <small class="ps-2 ms-1 text-uppercase text-xs font-weight-bolder opacity-9">Account pages</small>
          </li>
